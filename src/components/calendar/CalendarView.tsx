    ...
    return (
      <div className="h-full">
        <FullCalendar
          ...
          height="100%"
          events={events}
          editable={true}                 // Allows moving and resizing events on the calendar
          droppable={true}                  // Allows accepting external items
          drop={handleDrop}                 // Handles the external drop
          eventDrop={handleEventChange}     // Handles moving an event
          eventResize={handleEventChange}   // Handles resizing an event
          selectable={false}
          selectMirror={false}
          dayMaxEvents={true}
          weekends={true}
