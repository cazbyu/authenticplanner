...
+CREATE TABLE IF NOT EXISTS "0007-ap-task-12wkgoals" (
...
+ALTER TABLE "0007-ap-task-12wkgoals" 
...
+CREATE INDEX IF NOT EXISTS idx_goal_tasks_goal_id ON "0007-ap-task-12wkgoals"(goal_id);