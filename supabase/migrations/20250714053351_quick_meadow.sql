/*
  ...
  1. Changes
    - Ensure image_path column exists on 0007-ap-key-relationships table
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE table_name = '0007-ap-key-relationships' AND column_name = 'image_path'
  ) THEN
    ALTER TABLE "0007-ap-key-relationships" ADD COLUMN image_path TEXT;
  END IF;
END $$;
...
UPDATE "0007-ap-key-relationships"
